...
class GAT(nn.Module):
    def __init__(self, num_features: int, gat_hidden: int, dropout: float = 0.1, nheads=8, bias: bool = False):
        ...
        self.attentions = [GC(in_features=num_features, out_features=gat_hidden) for _ in range(nheads)]
