# -*- coding: utf-8 -*-
"""
Created on 2024-02-08 (Thu) 11:35:26

Original
- https://github.com/microsoft/Drug-Interaction-Research/blob/DSN-DDI-for-DDI-Prediction/drugbank_test/inductive_train.py
...
import sys
sys.path.append('/workspace/home/azuma/DDI/github/HeteroGraph_DDI/DSN_DDI_based')
...
# %% Dataset
data_path = '/workspace/home/azuma/DDI/github/Drug-Interaction-Research/drugbank_test/'
df_ddi_train = pd.read_csv(data_path + 'inductive_data/fold1/train.csv')
df_ddi_s1 = pd.read_csv(data_path + 'inductive_data/fold1/s1.csv')
df_ddi_s2 = pd.read_csv(data_path + 'inductive_data/fold1/s2.csv')
